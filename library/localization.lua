...
local function switchfont(loc)
	...
	English = function()
		...
		font.smallfont = love.graphics.newFont('NeoSans.otf',14)
		font.imagebuttonfont = love.graphics.newFont('NeoSans.otf',20)
		font.bigfont = love.graphics.newFont('NeoSans.otf',50)
