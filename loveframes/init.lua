...
loveframes.config["DEFAULTSKIN"]		= "Black"
loveframes.config["ACTIVESKIN"]	   		= "Black"
...
--	require(dir .. "/third-party/middleclass/middleclass")
	...
	loveframes.style = require 'anim.style'
	loveframes.anim = require 'anim.anim'
