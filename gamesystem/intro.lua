...
function intro:load()
	...
	execute(function()
		...
		conversation.playConversation('RIVER',LocalizedString'LIFE IS A PRIVILEGE. TOO MANY PEOPLE TOOK IT FOR GRANTED.','sound/conversation/lifeisaprivilege.ogg')
		wait(4)
		conversation.playConversation('RIVER',LocalizedString'I DO NOT HAVE SUCH LUXURY TO SPARE.','sound/conversation/luxury.ogg')
		wait(3)
		conversation.playConversation('DOCTOR',LocalizedString'THE RESULT OF THE DIAGNOSIS HAS COME OUT.. ITS BAD NEWS.',nil,5)
		wait(2)
		conversation.playConversation('RIVER',LocalizedString'TORMENTED BY MY DISEASE, I HAVE LONG THIRST FOR A REASON TO LIVE FOR.','sound/conversation/reason.ogg')
		wait(2)
		conversation.playConversation('RIVER',LocalizedString'JUST TELL ME DOC, HOW MUCH TIME DO I HAVE LEFT?','sound/conversation/time_chinese.ogg')

		conversation.playConversation('DOCTOR',LocalizedString'WE DO HAVE TREATMENT. BUT IT WILL COST YOU CLOSE TO FOUR MILLION DOLLARS A YEAR.',nil,5)
		wait(3)
		conversation.playConversation('RIVER',LocalizedString'THIS IS MY ONLY WAY OUT.','sound/conversation/wayout.ogg')
		wait(5)
		conversation.playConversation('RIVER',LocalizedString'IN SOME SENSE, I TAKE UNWORTHY PEOPLES LIFE TO EXTEND MY OWN.','sound/conversation/unworthy.ogg')
		conversation.playConversation('RIVER',LocalizedString'BUT I KNOW ONE DAY, I WILL HAVE TO PAY MY DEBT.','sound/conversation/debt.ogg')
		self.OnFinish()
	end)
end
